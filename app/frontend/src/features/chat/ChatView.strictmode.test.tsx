...
describe("ChatView StrictMode remount", () => {
  ...
  it("restores the saved conversation after remount under StrictMode", () => {
    ...
    // simulate switching away (unmount) and back (remount), as App does between views
    act(() => root.unmount());
    root = createRoot(container);
    renderChat(root, container, "conversation-a");
